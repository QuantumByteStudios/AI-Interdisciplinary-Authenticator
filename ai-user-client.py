...
class ChatApp(ctk.CTk):
    def __init__(self):
        ...
        scrollbar = tk.Scrollbar(
            self.chat_frame, orient="vertical", takefocus=0)
        ...
        self.input_entry = tk.Entry(
            width=40, bg="#2E2E2E", fg="white", font=("Arial", 16))
        self.input_entry.grid(row=1, column=0, columnspan=2,
                              sticky="ew", padx=10, pady=(0, 10), ipady=15, ipadx=15)
        ...
        self.clear_chat_button = tk.Button(
            text="Clear Chat", command=self.clear_chat, bg="#DC3545", fg="white", font=("Arial", 12))
        self.clear_chat_button.grid(row=3, column=0, columnspan=2, padx=10, pady=(
            0, 10), ipadx=10, ipady=10, sticky="ew")
